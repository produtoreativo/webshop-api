...
| Skill | Purpose | Link |
|---|---|---|
| `webshop-api-local-testing` | Run and validate local tests for the webshop-api | [local/webshop-api-local-testing/SKILL.md](local/webshop-api-local-testing/SKILL.md) |
